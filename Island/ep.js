...
const episodes = [
    { title: 'الحلقة 1 : المجهول', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : حراس التميمة', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : موهبة جاي', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : سن ووجيرا', pageUrl: 'ep4.html' }
];
