...
const episodes = [
    { title: 'الحلقة 1 : قناع الخداع', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : أميرة الحجر الكريم', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : الأوني والتنين', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : ثعبان جاكوار', pageUrl: 'ep4.html' },
    { title: 'الحلقة 5 : صرخة رجل ميت', pageUrl: 'ep5.html' },
    { title: 'الحلقة 6 : الرجل الصامت', pageUrl: 'ep6.html' },
    { title: 'الحلقة 7 : لعبة الأقنعة', pageUrl: 'ep7.html' },
    { title: 'الحلقة 8 : الخوف عند الوصول', pageUrl: 'ep8.html' },
    { title: 'الحلقة 9 : إمكانية حقيقية', pageUrl: 'ep9.html' },
    { title: 'الحلقة 10 : مشكلة كبيرة في نينجاجو الصغير', pageUrl: 'ep10.html' }
];
