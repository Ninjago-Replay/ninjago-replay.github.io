...
const episodes = [
    { title: 'الحلقة 1 : سيئ السمعة', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : العدو الأول للشعب', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : اللغز', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : الكارثة الكبيرة', pageUrl: 'ep4.html' },
    { title: 'الحلقة 5 : مهمة مستحيلة', pageUrl: 'ep5.html' },
    { title: 'الحلقة 6 : العشاء مع ناداكان', pageUrl: 'ep6.html' },
    { title: 'الحلقة 7 : يوم الأمنيات', pageUrl: 'ep7.html' },
    { title: 'الحلقة 8 : الوسيلة الأخيرة', pageUrl: 'ep8.html' },
    { title: 'الحلقة 9 : عملية الهبوط في الوطن', pageUrl: 'ep9.html' },
    { title: 'الحلقة 10 : رحلة العودة', pageUrl: 'ep10.html' }
];
