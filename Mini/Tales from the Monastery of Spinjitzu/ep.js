...
const episodes = [
    { title: 'الحلقة 1 : فئة رئيسية', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : الأخضر والذهبي', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : تمرين نهاية الأسبوع', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : الفارس العنصري', pageUrl: 'ep4.html' },
    { title: 'الحلقة 5 : البرق الأزرق', pageUrl: 'ep5.html' },
    { title: 'الحلقة 6 : ساموراي إكستريم', pageUrl: 'ep6.html' },
];
