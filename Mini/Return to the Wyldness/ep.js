...
const episodes = [
    { title: 'الحلقة 1 : ملكة الغضب!', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : إلى الحمم البركانية!', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : متاهة من الانعكاسات', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : حان وقت للحصول على الأحمر', pageUrl: 'ep4.html' },
];
