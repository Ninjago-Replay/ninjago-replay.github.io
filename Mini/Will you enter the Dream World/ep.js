...
const episodes = [
    { title: 'الحلقة 1 : أغرب حلم', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : حلم رائع', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : حلم غريب', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : حلم فظيع', pageUrl: 'ep4.html' },
];
