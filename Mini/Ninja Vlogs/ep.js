...
const episodes = [
    { title: 'الحلقة 1 : أول فيديو نينجا على الإطلاق!', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : الوصولات والاكتشافات و... الدجاج...    ', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : طائر؟ طائرة؟... أوه تنين؟!', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : لقد حان الوقت... للتألق!', pageUrl: 'ep4.html' },
];
