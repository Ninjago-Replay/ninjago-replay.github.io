...
const episodes = [
    { title: 'الحلقة 1 : هيا نرقص', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : تطوير', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : معنى النصر', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : المتسلل', pageUrl: 'ep4.html' },
    { title: 'الحلقة 5 : المطاردة', pageUrl: 'ep5.html' },
    { title: 'الحلقة 6 : غيل غوسيب: نظرة أقرب', pageUrl: 'ep6.html' },
];
