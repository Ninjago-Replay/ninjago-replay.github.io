...
const episodes = [
    { title: 'الحلقة 1 : الأسطورة', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : مركبات وميكانيك', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : الأماكن الأسطورية', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : أخطر مطلوب لنينجاغو', pageUrl: 'ep4.html' },
    { title: 'الحلقة 5 : عالم الرقميات وما وراءه', pageUrl: 'ep5.html' },
    { title: 'الحلقة 6 : أسياد العناصر', pageUrl: 'ep6.html' },
    { title: 'الحلقة 7 : وحوش وتنانين', pageUrl: 'ep7.html' },
    { title: 'الحلقة 8 : عودة غارمدون', pageUrl: 'ep8.html' },
    { title: 'الحلقة 9 : توقع النينجا الأخضر', pageUrl: 'ep9.html' },
    { title: 'الحلقة 10 : أعظم المعارك', pageUrl: 'ep10.html' }
];
