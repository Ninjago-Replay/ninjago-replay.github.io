...
const episodes = [
    { title: 'الحلقة 1 : ألبوم الكاميرا الخاص بي', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : ارسم معي', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : 3 أشياء أتمنى أن أعرفها عن بيض التنين!', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : مترجم التنين', pageUrl: 'ep4.html' },
    { title: 'الحلقة 5 : تطبيق لتتبع المشاعر', pageUrl: 'ep5.html' },
    { title: 'الحلقة 6 : التأمل أو الانهيار', pageUrl: 'ep6.html' },
    { title: 'الحلقة 7 : وداعا للعظام', pageUrl: 'ep7.html' },
    { title: 'الحلقة 8 : دروس تعلمتها في البرية', pageUrl: 'ep8.html' },
];
