...
const episodes = [
    { title: 'الحلقة 1 : العملية: المعادن الثقيلة - ماشيا', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : عملية: المعادن الثقيلة - بافميليون    ', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : عملية: المعادن الثقيلة - بلانك', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : العملية: المعادن الثقيلة - راجمونك', pageUrl: 'ep4.html' },
];
