...
const episodes = [
    { title: 'الحلقة 1 : الفضول', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : التوازن', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : الحكمة', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : الصدق', pageUrl: 'ep4.html' },
    { title: 'الحلقة 5 : الكرم', pageUrl: 'ep5.html' },
    { title: 'الحلقة 6 : الشجاعة', pageUrl: 'ep6.html' },
];
