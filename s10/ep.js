...
const episodes = [
    { title: 'الحلقة 1 : قدوم الظلام', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : دخل الظلام', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : السقوط', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : النهايات', pageUrl: 'ep4.html' }
];
