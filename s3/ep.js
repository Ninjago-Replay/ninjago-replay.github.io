...
const episodes = [
    { title: 'الحلقة 1 : الخلل', pageUrl: 'ep1.html' },
    { title: 'الحلقة 2 : فن القبضة الصامتة    ', pageUrl: 'ep2.html' },
    { title: 'الحلقة 3 : اضلام تام', pageUrl: 'ep3.html' },
    { title: 'الحلقة 4 : لعنة المعلم الذهبي', pageUrl: 'ep4.html' },
    { title: 'الحلقة 5 : العالم الرقمي', pageUrl: 'ep5.html' },
    { title: 'الحلقة 6 : الرمز اركتورس', pageUrl: 'ep6.html' },
    { title: 'الحلقة 7 : الفراغ', pageUrl: 'ep7.html' },
    { title: 'الحلقة 8 : نينجا تيتانيوم', pageUrl: 'ep8.html' }
];
